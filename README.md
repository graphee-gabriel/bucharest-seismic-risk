This application was built to provide a quick way to find out the seismic risk category of a building in Bucharest, from its address, and other details provided by the townhall.
